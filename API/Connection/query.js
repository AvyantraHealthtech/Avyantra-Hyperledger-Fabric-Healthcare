...
// invokeChaincode("user3", "ISOcode","createUser", "mychannel", ['USER14','S301','R202','10March','3','4'], function(err,res){
//     console.log(err,res);
// });


// invokeChaincode("user3", "ISOcode","createBalance", "mychannel", ['S301I4','-33'], function(err,res){
//     console.log(err,res);
// });


// invokeChaincode("user3", "ISOcode","createBalance", "mychannel", ['R202I4','33'], function(err,res){
//     console.log(err,res);
// });

// postTransaction("user3", "ISOcode", "querySingle",["BAL22"], function(err,res){
//     console.log(err,res);
// });


// postTransaction("user3", "ISOcode", "richQuery",["AssetID","3"], function(err,res){
//         console.log(err,res);
//       });
